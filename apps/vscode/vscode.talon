...
select quote: user.vscode("selectSingleQuote")
select dubquote: user.vscode("extension.selectDoubleQuote")
select paren: user.vscode("selectParenthesis")
select square: user.vscode("selectSquareBrackets")
select brace: user.vscode("selectCurlyBrackets")
select tag: user.vscode("selectAngleBrackets")
change quotes: user.vscode("switchQuotes")
